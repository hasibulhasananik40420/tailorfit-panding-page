...
const Testimonial = () => {
      ...
      {showVideo ? (
        ...
        <>
          ...
          <div onClick={() => setShowVideo(true)} className="cursor-pointer">
           ...
           <div
       className={`w-[100%] rounded md:flex justify-between items-center min-h-[384px] ${
        showVideoTwo ? '' : "bg-[url('/images/Mask2.png')] bg-cover bg-center bg-no-repeat pt-[60px] md:pt-[0px] lg:pt-0 lg:px-[50px] md:px-[100px] px-4"
      }`}
       >
      {showVideoTwo ? (
        <div className="w-full h-[384px]">
          ...
          <iframe
            className="w-full h-full rounded"
            src="https://www.youtube.com/embed/0AoPwF8OlsE?si=S9upZdyizV4hShhI"
            title="YouTube video player"
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
  ...
  <div
       className={`w-[100%] rounded md:flex justify-between items-center min-h-[384px] ${
        showVideoThree ? '' : "bg-[url('/images/Mask3.png')] bg-cover bg-center bg-no-repeat pt-[60px] md:pt-[0px] lg:pt-0 lg:px-[50px] md:px-[100px] px-4"
      }`}
       >
      {showVideoThree ? (
        <div className="w-full h-[384px]">
  ...
  <div
       className={`w-[100%] rounded md:flex justify-between items-center min-h-[384px] ${
        showVideoFour ? '' : "bg-[url('/images/Mask4.png')] bg-cover bg-center bg-no-repeat pt-[60px] md:pt-[0px] lg:pt-0 lg:px-[50px] md:px-[100px] px-4"
      }`}
       >
      {showVideoFour ? (
        <div className="w-full h-[384px]">
